...
obtainInstruction('steak', 0)
  ...
  .then((step7) => {
    ...
    document.querySelector("#steak").innerHTML += `<li><strong>Steak is ready!</strong></li>`;
  })
  .catch((error) => {
...
async function makeBrusselsSprouts() {
  try {
    ...
    document.querySelector("#brusselsSprouts").innerHTML += `<li><strong>Brussels sprouts are ready!</strong></li>`;
  } catch (error) {
    console.error("Error fetching instructions:", error);
  }
}
...
async function makeBroccoli() {
  try {
    ...
    document.querySelector("#broccoli").innerHTML += `<li><strong>Broccoli is ready!</strong></li>`;
  } catch (error) {
